 ...
 * entry being accessed (0-31).
 */
#define C0_WRITE_INDEX(x)    __asm__("mtc0 %0,$0; nop; nop"::"r"(x))
 ...
 */
#define C0_WRITE_ENTRYHI(x)  __asm__("mtc0 %0,$10; nop; nop"::"r"(x))
 ...
 * of the physical memory entry (even bank) for the TLB slot being accessed.
 */
#define C0_WRITE_ENTRYLO0(x) __asm__("mtc0 %0,$2; nop; nop"::"r"(x))
 ...
 * of the physical memory entry (even bank) for the TLB slot being accessed.
 */
#define C0_WRITE_ENTRYLO1(x) __asm__("mtc0 %0,$3; nop; nop"::"r"(x))
 ...
 * configures the page size of the TLB slot being accessed.
 */
#define C0_WRITE_PAGEMASK(x) __asm__("mtc0 %0,$5; nop; nop"::"r"(x))
 ...
 * range [0..WIRED[ and the random pool is the range [WIRED..32[
 */
#define C0_WRITE_WIRED(x) __asm__("mtc0 %0,$6; nop; nop"::"r"(x))
 ...
 */
#define C0_TLBWI()           __asm__("tlbwi; nop; nop; nop; nop")
 ...
 */
#define C0_TLBWR()           __asm__("tlbwr; nop; nop; nop; nop")
 ...
 * ENTRYLO1.
 */
#define C0_TLBR()            __asm__("tlbr; nop; nop; nop; nop")
 ...
 * in INDEX.
 */
#define C0_TLBP()            __asm__("tlbp; nop; nop; nop; nop")
