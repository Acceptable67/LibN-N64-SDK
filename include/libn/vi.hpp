...
namespace LibN64 
{
	namespace Display 
	{
		...
		extern LibN64::Display::Resolution GRes;
		extern const Resolution RESOLUTION_320x240;
		extern const Resolution RESOLUTION_640x480;
		extern const Resolution RESOLUTION_480x360;
		extern const Resolution RESOLUTION_400x440;
		extern const Resolution RESOLUTION_640x222;
		...
		u32 *GetActiveBuffer();
		u32 *GetBuffer(Buffer frameBuffer);
		void SwapBuffers();
