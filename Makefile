...
entry.o: entry.S
	$(N64_INST)/mips64-elf-gcc -c -std=gnu98 $(CFLAGS) $< -o $@ 

main.o: main.cpp
	$(N64_INST)/mips64-elf-g++ -c -std=c++20 $(CFLAGS) $< -o $@ 

file.elf: main.o entry.o
	$(N64_INST)/mips64-elf-g++ -o $@ -L/usr/local/mips64-elf/lib/ -L/usr/local/mips64-elf/mips64-elf/lib/ -L/usr/local/lib/ -lm -lc -lgcc -T/home/spencer/libdragon/NEW/libdragon/n64.ld *o  
