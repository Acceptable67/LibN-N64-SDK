...
CFLAGS = -march=vr4300 -mtune=vr4300 -Wall -Wextra -Werror -O3  -I/usr/local/mips64-elf/include -I/usr/local/include/
...
file.z64: file.bin
	$(TOOLS)/n64tool -l 2M -t "test" -h /home/spencer/libdragon/NEW/libdragon/header -o $@ $< -s 1M sky.sprite 
	$(TOOLS)/chksum64 $@
